...
<html lang="zh-CN">
 ...
 <body>
    ...
    <div class="panel panel-info">
	 ...
	 <!-- Form -->
	<form id="formid" action="${pageContext.request.contextPath}/AddGoodsServlet?flag=add" enctype="multipart/form-data" 
		...
		<div class="form-group col-md-12">
			...
			<div class="col-sm-10 form-group has-feedback" id="div-photo" style="width:30%;">						  
		...
		<div class="form-group col-md-12">
			...
			<div class="col-sm-10 form-group has-feedback" id="div-descript" style="width:30%;">						  
				...
				<textarea rows="4" name="descript" id="descript" class="form-control" style="border-radius:3px;">                   

	            </textarea>
				<label id="label-descript-1" class="control-label" style="display: none;">描述不能为空</label>
				<label id="label-descript-2" class="control-label" style="display: none;">输入的格式不正确，字数限制在30字符内</label>						
			</div>
		</div>
		...
		$(document).ready(function() {
			...
			$("#save-1").click(function(){
				...
				if($("#descript").val()==''){
					...
					//判断描述不超过30个字符
					var reg1 = new RegExp(/^([A-Za-z0-9\u4e00-\u9fa5\w\W]{1,30})$/);
					//alert("格式错误");
